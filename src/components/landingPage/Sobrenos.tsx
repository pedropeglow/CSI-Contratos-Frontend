        ...
        <div className="row">
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item">
              ...
              <p>Estudante de Análise e desenvolvimento de Sistemas e atualmente trabalhando como Dev Full-Stack Jr</p>
              <ul className="team-icon">
                <li><a href="https://github.com/pedropeglow" className="github" target="_blank">
                  <GitHub/>
                </a></li>
                <li><a href="https://www.linkedin.com/in/pedro-peglow/" className="linkedin" target="_blank">
                  <LinkedIn />
                </a></li>
              </ul>
            </div>
          ...
          <div className="col-sm-6 col-md-4">
            <div className="team-item">
              <img src="https://media.licdn.com/dms/image/C4D03AQHPRT-eijqsKw/profile-displayphoto-shrink_200_200/0/1604273357054?e=1726704000&v=beta&t=qRjflmvtt4IIFKzK6WRGKul7UxGNguVXDcjbqAKoHKQ" className="team-img" alt="pic" />
              <h3>WAGNER SOUZA</h3>
              <div className="team-info"><p>Desenvolvedor Back-end do CSI</p></div>
              <p>Eterno estudante. Amante da tecnologia.</p>
              <ul className="team-icon">
                <li><a href="https://github.com/wagnersouzadepaula" className="github" target="_blank"><GitHub/></a></li>
                <li><a href="https://www.linkedin.com/in/wagner-s-paula-815b6892/" className="linkedin" target="_blank"><LinkedIn /></a></li>
              </ul>
            </div>
          </div>
          </div>
